...
import { StudyInfo, TableInfo, ExtractionRequest, ExtractionResponse } from '../lib/api';
...
export const fetchDummyColumns = (schema: string, tableName: string): { columns: string[] } => {
...
export const processDummyExtraction = (request: ExtractionRequest): ExtractionResponse => {
